...
"soldado",
"corajoso",
["salvar", "guardar", "economizar", "poupar"],
"comprar",
"montar",
"sela",
"passeia",
...
"wedding"
			...
			function exportarParaGoogleTradutor(){
				var auxpalavra = [dicionarioDePortugues.palavras.slice(), dicionarioDeIngles.palavras.slice()];
				var auxpalavracount = auxpalavra[0].length;
				var auxidpalavramin = 0;
				var auxidpalavramax = auxpalavracount - 1;
				var auxidpalavra = getRandomIntInclusive(auxidpalavramin, auxidpalavramax);			

				document.getElementById("arqdicionario").value = "";
				if(idioma.options[idioma.selectedIndex].value == "ingles"){
					for(let i = 0; i < auxpalavracount; i++){
						document.getElementById("arqdicionario").value += "|" + auxpalavra[1][auxidpalavra] + "|" + auxpalavra[0][auxidpalavra];
						auxpalavra[0].splice(auxidpalavra, 1);
						auxpalavra[1].splice(auxidpalavra, 1);
						auxidpalavramax--;
						auxidpalavra = getRandomIntInclusive(auxidpalavramin, auxidpalavramax);	
					}
				}
				else if(idioma.options[idioma.selectedIndex].value == "portugues"){
					for(let i = 0; i < auxpalavracount; i++){
						document.getElementById("arqdicionario").value += "|" + auxpalavra[0][auxidpalavra] + "|" + auxpalavra[1][auxidpalavra];
						auxpalavra[0].splice(auxidpalavra, 1);
						auxpalavra[1].splice(auxidpalavra, 1);
						auxidpalavramax--;
						auxidpalavra = getRandomIntInclusive(auxidpalavramin, auxidpalavramax);	
			...
			function verificarSistema(){
				...
				console.log("Palavras repetidas: " + numDuplicada);
			...
			function repararSistema(){
				...
				for(let i = 0; i < palavra[1].length; i++){
					for(let j = 0; j < palavra[1].length; j++){
						if(i != j && palavra[1][i] == palavra[1][j]){
							palavra[0].splice(j, 1);
							palavra[1].splice(j, 1);
						}
					}
				}
				idpalavramax = palavra[1].length - 1;
